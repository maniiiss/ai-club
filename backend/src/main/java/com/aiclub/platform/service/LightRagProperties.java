 ...
 * 切流开关（assistant-evidence-enabled / graph-enabled）默认关闭，走旧链路，保证灰度可回滚。
 */
@Component
public class LightRagProperties {
    ...
    public LightRagProperties(
            ...
            @Value("${platform.lightrag.assistant-evidence-enabled:false}") boolean assistantEvidenceEnabled,

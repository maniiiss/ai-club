...
/**
 * Assistant 内置 Skill 抽象基类。
 * 负责统一加载 Markdown 提示词资源，以及提供常用的关键词匹配辅助方法。
 */
public abstract class AbstractAssistantPromptSkill implements AssistantPromptSkill {

    private final String promptMarkdown;

    protected AbstractAssistantPromptSkill(AssistantPromptResourceLoader resourceLoader, String resourcePath) {
        this.promptMarkdown = resourceLoader.readRequiredMarkdown(resourcePath);
    }

    @Override
    public String renderSystemFragment(AssistantSkillContext context) {

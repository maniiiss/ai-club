...
/**
 * Assistant 语音转写的系统级配置。
 * 第一版仅负责接 OpenAI 兼容转写接口，不复用文档资产或模型中心配置。
 */
@Component
public class AssistantSpeechProperties {
    ...
    public AssistantSpeechProperties(String baseUrl,
                                  String apiKey,
                                  String model,
                                  int timeoutSeconds,
    ...
    private AssistantSpeechProperties(String baseUrl,
                                   String apiKey,
                                   String model,

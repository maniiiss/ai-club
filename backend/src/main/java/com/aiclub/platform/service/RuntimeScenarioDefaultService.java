...
public class RuntimeScenarioDefaultService {
    ...
    private static Map<String, ScenarioDefinition> definitions() {
        ...
        result.put(SCENARIO_ASSISTANT, new ScenarioDefinition(SCENARIO_ASSISTANT, "GitPilot 助手", RuntimeChatService.DEFAULT_RUNTIME, Set.of(RuntimeCapability.CHAT)));
        result.put(SCENARIO_CHAT_ROOM, new ScenarioDefinition(SCENARIO_CHAT_ROOM, "聊天室 Assistant", RuntimeChatService.DEFAULT_RUNTIME, Set.of(RuntimeCapability.CHAT)));

...
/**
 * 独立菜单入口下的 API 管理控制器。
 * `projectId` 为空时表示使用“未关联项目”的公共 API 空间。
 */
@RestController
...
public class ApiManagementController {
    ...
    public ApiManagementController(ProjectApiManagementService projectApiManagementService) {
        this.projectApiManagementService = projectApiManagementService;
    }

    @GetMapping("/profile")
    @RequirePermission("api:view")
    public ApiResponse<ProjectApiProfileSummary> getProfile(@RequestParam(required = false) Long projectId) {
        return ApiResponse.success(projectApiManagementService.getProfile(projectId));
    }

    @PutMapping("/profile")
    @RequirePermission("api:manage")
    public ApiResponse<ProjectApiProfileSummary> updateProfile(@RequestParam(required = false) Long projectId,
    ...
    @GetMapping("/tree")
    @RequirePermission("api:view")
    public ApiResponse<ProjectApiTreeSummary> getTree(@RequestParam(required = false) Long projectId) {
        return ApiResponse.success(projectApiManagementService.getTree(projectId));
    }

    @PostMapping("/folders")
    @RequirePermission("api:manage")
    public ApiResponse<ProjectApiFolderSummary> createFolder(@RequestParam(required = false) Long projectId,
    ...
    @RequirePermission("api:manage")
    public ApiResponse<ProjectApiFolderSummary> updateFolder(@RequestParam(required = false) Long projectId,
    ...
    @RequirePermission("api:manage")
    public ApiResponse<Void> deleteFolder(@RequestParam(required = false) Long projectId,
                                          @PathVariable Long folderId) {
    ...
    @RequirePermission("api:view")
    public ApiResponse<ProjectApiEndpointDetail> getEndpoint(@RequestParam(required = false) Long projectId,
    ...
    @RequirePermission("api:manage")
    public ApiResponse<ProjectApiEndpointDetail> createEndpoint(@RequestParam(required = false) Long projectId,
    ...
    @RequirePermission("api:manage")
    public ApiResponse<ProjectApiEndpointDetail> updateEndpoint(@RequestParam(required = false) Long projectId,
                                                                @PathVariable Long endpointId,
                                                                @Valid @RequestBody ProjectApiEndpointRequest request) {
    ...
    @RequirePermission("api:manage")
    public ApiResponse<Void> deleteEndpoint(@RequestParam(required = false) Long projectId,
                                            @PathVariable Long endpointId) {
    ...
    @RequirePermission("api:view")
    public ApiResponse<List<ProjectApiEnvironmentSummary>> listEnvironments(@RequestParam(required = false) Long projectId) {
        return ApiResponse.success(projectApiManagementService.listEnvironments(projectId));
    }

    @PostMapping("/environments")
    @RequirePermission("api:manage")
    public ApiResponse<ProjectApiEnvironmentSummary> createEnvironment(@RequestParam(required = false) Long projectId,
    ...
    @RequirePermission("api:manage")
    public ApiResponse<ProjectApiEnvironmentSummary> updateEnvironment(@RequestParam(required = false) Long projectId,
    ...
    @RequirePermission("api:manage")
    public ApiResponse<Void> deleteEnvironment(@RequestParam(required = false) Long projectId,
                                               @PathVariable Long environmentId) {
    ...
    @RequirePermission("api:manage")
    public ApiResponse<ProjectApiImportResult> importOpenApi(@RequestParam(required = false) Long projectId,
    ...
    @RequirePermission("api:view")
    public ApiResponse<ProjectApiExportDocument> exportOpenApi(@RequestParam(required = false) Long projectId,
    ...
    @RequirePermission("api:view")
    public ApiResponse<List<ProjectApiDebugRecordSummary>> listDebugRecords(@RequestParam(required = false) Long projectId,
    ...
    @RequirePermission("api:manage")
    public ApiResponse<ProjectApiDebugRecordSummary> executeDebug(@RequestParam(required = false) Long projectId,
                                                                  @PathVariable Long endpointId,

...
/**
 * Hermes 用户消息关联的文档附件，保存原始文档资产与本次转换后的 Markdown。
 */
@Entity
@Table(name = "hermes_conversation_attachment")
public class HermesConversationAttachmentEntity {
    ...
    private HermesConversationMessageEntity message;
    ...
    public HermesConversationMessageEntity getMessage() {
        return message;
    }

    public void setMessage(HermesConversationMessageEntity message) {

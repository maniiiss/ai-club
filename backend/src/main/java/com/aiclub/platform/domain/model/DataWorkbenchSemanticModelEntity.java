...
public class DataWorkbenchSemanticModelEntity {
    ...
    public String getPublishedSchemaSnapshotJson(){return publishedSchemaSnapshotJson;} public void setPublishedSchemaSnapshotJson(String v){publishedSchemaSnapshotJson=v;} public Long getModelConfigId(){return modelConfigId;} public void setModelConfigId(Long v){modelConfigId=v;} public void setModelNameSnapshot(String v){modelNameSnapshot=v;} public void setModelProviderSnapshot(String v){modelProviderSnapshot=v;} public void setModelIdentifierSnapshot(String v){modelIdentifierSnapshot=v;}

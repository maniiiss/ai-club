...
/**
 * Hermes 会话轻量审计日志，用于排障与运营分析，不承担记忆召回职责。
 */
@Entity
@Table(name = "hermes_chat_audit")
public class HermesChatAuditEntity {
    ...
    /**
     * Hermes 网关返回的响应标识，便于关联远端日志。
     */
    @Column(name = "hermes_response_id", length = 120)
    private String hermesResponseId;
    ...
    public String getHermesResponseId() {
        return hermesResponseId;
    }

    public void setHermesResponseId(String hermesResponseId) {
        this.hermesResponseId = hermesResponseId;
    }

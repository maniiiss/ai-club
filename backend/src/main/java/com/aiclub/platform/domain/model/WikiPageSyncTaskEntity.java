...
/**
 * Wiki 页面同步到 Hindsight 的出站任务实体，保证外部索引失败不会阻塞主业务保存。
 */
@Entity
@Table(name = "wiki_page_sync_task")
public class WikiPageSyncTaskEntity {

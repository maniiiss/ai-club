...
class HermesAndHindsightPropertiesTests {

    @Mock
    private PlatformEnvVarResolver platformEnvVarResolver;

    @Test
    void shouldReadHermesBaseUrlAndApiKeyFromDeploymentConfigOnly() {
    ...
    @Test
    void shouldKeepHermesModelAndTimeoutAsRuntimeManagedFields() {

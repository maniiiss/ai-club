...
const displayLabels = computed(() => props.options.filter((item) => props.modelValue.includes(item.value)).map((item) => item.label));
...
/** @type {__VLS_StyleScopedClasses['compact-select-trigger']} */ ;
/** @type {__VLS_StyleScopedClasses['compact-select-trigger']} */ ;
/** @type {__VLS_StyleScopedClasses['compact-multi-value']} */ ;
...
__VLS_3.slots.default;
{
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
        ...{ class: "compact-multi-value" },
        ...{ class: ({ placeholder: !__VLS_ctx.displayLabels.length }) },
    });
...
for (const [item] of __VLS_getVForSourceType((__VLS_ctx.options))) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...{ onClick: (...[$event]) => {
                __VLS_ctx.toggle(item.value);
            } },
        key: (String(item.value)),
        ...{ class: "compact-select-item" },
        ...{ class: ({ active: __VLS_ctx.isChecked(item.value) }) },
        type: "button",
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({});
    (item.label);
    if (__VLS_ctx.isChecked(item.value)) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
...
//# sourceMappingURL=CompactMultiSelectMenu.vue.js.map
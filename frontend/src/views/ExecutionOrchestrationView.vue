...
<style scoped>
.orchestration-page { display: flex; flex-direction: column; gap: 16px; height: 100%; overflow: hidden; color: #172033; }
.orchestration-hero { display: flex; align-items: center; justify-content: space-between; gap: 16px; padding: 16px 22px; border: 1px solid rgba(15, 118, 110, .18); border-radius: 14px; background: radial-gradient(circle at 88% 16%, rgba(20, 184, 166, .18), transparent 30%), linear-gradient(135deg, #f0fdfa 0%, #f8fafc 64%); box-shadow: 0 8px 24px rgba(15, 23, 42, .05); }
...
.orchestration-hero h1 { margin: 4px 0; font-size: 22px; letter-spacing: -.03em; }
.orchestration-hero p { max-width: 760px; margin: 0; color: #64748b; line-height: 1.55; }
.orchestration-hero-badge { display: grid; min-width: 92px; padding: 10px 14px; border-radius: 12px; background: #0f766e; color: white; text-align: center; box-shadow: 0 6px 14px rgba(15, 118, 110, .22); }
.orchestration-hero-badge span { font-size: 22px; font-weight: 900; }.orchestration-hero-badge small { opacity: .78; }
...
.scenario-rail { display: flex; gap: 10px; overflow-x: auto; padding-bottom: 4px; }.scenario-chip { display: grid; grid-template-columns: auto auto; align-items: center; gap: 2px 8px; min-width: 220px; padding: 12px 14px; border: 1.5px solid #e2e8f0; border-radius: 13px; background: white; color: #334155; text-align: left; cursor: pointer; transition: .18s ease; }.scenario-chip:hover { border-color: rgba(15,118,110,.42); transform: translateY(-1px); box-shadow: 0 8px 18px rgba(15,23,42,.06); }.scenario-chip.active { border-color: #0f766e; background: #f0fdfa; box-shadow: inset 3px 0 0 #0f766e, 0 4px 12px rgba(15,118,110,.12); }.scenario-chip small { grid-column: 2; color: #94a3b8; }.scenario-dot { width: 8px; height: 8px; border-radius: 50%; background: #f59e0b; }.scenario-dot.ready { background: #10b981; box-shadow: 0 0 0 4px rgba(16,185,129,.1); }
.orchestration-grid { display: grid; grid-template-columns: minmax(0, 1fr) 340px; gap: 16px; flex: 1; min-height: 0; align-items: start; }.orchestration-editor-card,.orchestration-history-card { display: flex; flex-direction: column; min-height: 0; border: 1px solid #e2e8f0; border-radius: 16px; background: #fff; box-shadow: 0 12px 30px rgba(15,23,42,.04); }.orchestration-editor-card { padding: 20px; overflow: hidden; }.orchestration-card-head { display: flex; align-items: flex-start; justify-content: space-between; gap: 16px; }.orchestration-card-head h2,.orchestration-history-card h3 { margin: 5px 0 0; }.orchestration-status-strip { display: grid; grid-template-columns: repeat(4,minmax(0,1fr)); gap: 8px; margin: 18px 0; }.orchestration-status-strip div { display: flex; flex-direction: column; gap: 5px; padding: 11px 12px; border-radius: 10px; background: #f8fafc; }.orchestration-status-strip span { color: #94a3b8; font-size: 11px; }.orchestration-status-strip strong { font-size: 13px; }
...
.orchestration-history-card { padding: 18px; overflow: hidden; max-height: 520px; }.history-list { display: flex; flex-direction: column; gap: 10px; margin-top: 14px; flex: 1; min-height: 0; overflow-y: auto; padding-right: 4px; }.history-item { padding: 13px; border: 1px solid #e2e8f0; border-radius: 12px; background: #f8fafc; }.history-main { display: flex; align-items: center; justify-content: space-between; }.history-item p { margin: 6px 0 10px; color: #94a3b8; font-size: 11px; }.history-item ul { display: flex; flex-direction: column; gap: 6px; margin: 0 0 8px; padding: 0; list-style: none; }.history-item li { display: grid; grid-template-columns: minmax(0,1fr) minmax(0,1.4fr) auto; gap: 7px; font-size: 11px; }.history-item li span { color: #64748b; }.history-item li strong { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.history-item li small { color: #0f766e; }

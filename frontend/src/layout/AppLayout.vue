...
const platformMenuSeedMap: Record<(typeof PLATFORM_MANAGEMENT_PERMISSION_CODES)[number], MenuSeed> = {
  ...
  'runtime:manage': { permission: 'runtime:manage', fallbackPath: '/runtime-registry', fallbackLabel: 'Runtime 注册中心', shortLabel: 'Runtime', fallbackIcon: Connection, matchNames: ['runtime-registry'] },

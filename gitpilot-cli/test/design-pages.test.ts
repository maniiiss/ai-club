...
import { designPageIdFromEntryPath, synchronizeDesignPages } from "../src/modes/rpc/design-pages.ts";

describe("Design 页面索引", () => {
	it("只从 canonical 页面入口路径提取页面标识", () => {
		expect(designPageIdFromEntryPath("pages/about/index.html")).toBe("about");
		expect(designPageIdFromEntryPath("about/index.html")).toBeUndefined();
		expect(designPageIdFromEntryPath("pages/about/Index.html")).toBeUndefined();
	});

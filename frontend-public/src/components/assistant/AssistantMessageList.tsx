...
const AttachmentBar = ({ attachments }: { attachments: AssistantAttachmentItem[] }) => {
      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-4">
        {messages.map((message) => {
          const assistantDisplay = message.role === 'assistant'
            ? resolveAssistantDisplayState(message, streamingActive)
            : null
          return (

...
import type { HermesSelectionCardItem, HermesSelectionOptionItem, HermesSelectionPayload } from '@/src/types/hermes'

interface HermesSelectionCardsProps {
  cards: HermesSelectionCardItem[]
  disabled: boolean
  onSelect: (selection: HermesSelectionPayload) => void
}

const toSelection = (card: HermesSelectionCardItem, option: HermesSelectionOptionItem): HermesSelectionPayload | null => {
...
export const HermesSelectionCards = ({ cards, disabled, onSelect }: HermesSelectionCardsProps) => {

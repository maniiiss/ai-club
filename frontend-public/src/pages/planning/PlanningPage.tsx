...
export const PlanningPage = () => {
  ...
  /**
   * 详情头部统一使用 Sparkles 智能入口：需求/测试任务进入需求 AI，开发任务/缺陷进入开发执行。
   */
...
const WorkItemDetailDrawer = ({ item, loading, userOptions, canGoBack, canCreateExecution, onBack, onClose, onEdit, onDelete, onRefresh, onOpenLinkedWorkItem, onOpenAi }: {
  ...
  const headerActions = (
    <>
      ...
      {(isRequirementAiEntryVisible(item) || (canCreateExecution && isDevelopmentExecutionEntryVisible(item))) && onOpenAi && (

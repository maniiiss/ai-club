...
> 平台权限分为 **功能权限**(能否进入页面/调用接口)与 **数据权限**(具备功能权限后能看到哪些项目及其绑定资源)两层。详见 [docs/design-docs/current-permission-model.md](docs/design-docs/current-permission-model.md)。
...
目标分支缺少 `.woodpecker.yml` 时，详情页的「补全配置」会以模板参数表单生成配置：用户填写项目根目录、推送服务器地址、分支、Docker 凭据、SSH 主机和私钥等，平台创建 GitLab MR，敏感值写入 Woodpecker repo secrets。「部署到服务器」作为共享后置动作挂在 Java / Node / Python / Docker 等模板里。高级用户仍可切换到手动 YAML 模式。详细设计见 [docs/design-docs/pipeline-woodpecker-provider-technical-design-v1.md](docs/design-docs/pipeline-woodpecker-provider-technical-design-v1.md)。
...
- 推荐基于 [docs/design-docs/architecture-design-template.md](docs/design-docs/architecture-design-template.md) 新建 `docs/design-docs/<主题>-architecture-v1.md` 或 `docs/design-docs/<主题>-technical-design-v1.md`。
...
| [docs/design-docs/current-permission-model.md](docs/design-docs/current-permission-model.md) | 当前权限模型(功能权限 + 数据权限) |
| [docs/design-docs/observability-technical-design-v1.md](docs/design-docs/observability-technical-design-v1.md) | 可观测性中心(项目日志 + 健康监控)技术设计 |
| [docs/design-docs/public-saas-frontend-technical-design-v1.md](docs/design-docs/public-saas-frontend-technical-design-v1.md) | 公众 SaaS 产品前端技术设计 |
| [docs/design-docs/public-credit-technical-design-v1.md](docs/design-docs/public-credit-technical-design-v1.md) | 公众端积分扣费技术设计 |
| [docs/design-docs/api-studio-native-technical-design-v1.md](docs/design-docs/api-studio-native-technical-design-v1.md) | 原生 API 工作台技术设计 |
| [docs/design-docs/wiki-knowledge-graph-technical-design-v1.md](docs/design-docs/wiki-knowledge-graph-technical-design-v1.md) | Wiki 知识图谱技术设计 |
| [docs/design-docs/model-benchmark-technical-design-v1.md](docs/design-docs/model-benchmark-technical-design-v1.md) | 模型对比测试技术设计 |

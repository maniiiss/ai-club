...
- `GET /api/hermes/file-library`
- `POST /api/hermes/file-library/upload`
- `PATCH /api/hermes/file-library/{id}`
- `DELETE /api/hermes/file-library/{id}`
- `POST /api/hermes/file-library/{id}/reindex`

...
import { Check, CircleDot, FileDiff, FilePenLine, FileSearch, FolderTree, ListChecks, Play, Plus, Terminal, TriangleAlert, Wrench, X } from 'lucide-react';
